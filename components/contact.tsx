    ...
    <section className="relative z-10 py-24 bg-gradient-to-b from-background/50 to-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 rounded-xl border border-border bg-card hover:border-primary/50 transition-colors duration-200 text-center">
            <Mail className="w-8 h-8 text-primary mx-auto mb-3" />
            <h3 className="font-bold text-foreground mb-2">Email</h3>
            <Link
              href="mailto:sssujith39143@gmail.com"
          ...
          <div className="p-6 rounded-xl border border-border bg-card hover:border-primary/50 transition-colors duration-200 text-center">
            ...
            <Link href="tel:+919490936857" className="text-muted-foreground hover:text-primary transition-colors">
              +91 9490936857
            </Link>
          </div>
        ...
        <div className="mb-12 p-8 rounded-xl border border-border bg-card/50 backdrop-blur-sm">
        ...
        <div className="flex justify-center gap-6 mb-12">
          <Link
            href="https://linkedin.com/in/tenali-sujith-kumar"
            target="_blank"
            rel="noopener noreferrer"
            className="p-4 rounded-xl border border-border bg-card hover:border-primary hover:bg-primary/5 transition-all duration-200"
            aria-label="LinkedIn"
          >
            <Linkedin className="w-6 h-6 text-primary" />
          </Link>
          <Link
            href="https://github.com/Sujith-2210"
            target="_blank"
            rel="noopener noreferrer"
            className="p-4 rounded-xl border border-border bg-card hover:border-primary hover:bg-primary/5 transition-all duration-200"
            aria-label="GitHub"
