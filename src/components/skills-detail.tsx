  ...
  return (
    <section className="relative z-10 py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {skillsData.map((skillGroup, index) => {
            ...
            return (
              <div
                key={index}
                className="p-8 rounded-xl border border-border liquid-glass hover:border-primary/50 transition-all duration-200 hover:shadow-lg hover:shadow-primary/10"
              >
        ...
        <div className="mt-16 p-8 rounded-xl border border-border liquid-glass backdrop-blur-sm">
