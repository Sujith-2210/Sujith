...
export default function Projects() {
  return (
    <section id="projects" className="relative z-10 py-24 bg-gradient-to-b  ">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {projects.map((project, index) => (
            <div
              ...
              className={`group relative p-6 rounded-xl border transition-all duration-300 hover:border-primary ${
                project.highlighted
                  ? "md:col-span-1 liquid-glass border-primary/50 hover:liquid-glass"
                  : "liquid-glass border-border hover:border-secondary"
              }`}
            >
        ...
        <div className="mt-12 p-8 rounded-xl border border-border liquid-glass backdrop-blur-sm">
